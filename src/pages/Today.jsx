  ...
  const fetchOrdo = async () => {
    try {
      ...
      const res = await axios.get(
        `${process.env.REACT_APP_API_URL}/ordonnance/today?page=${currentPage}&search=${filters.search}&date=${filters.date}&numero=${filters.numero}`,
        {
          headers: {
  ...
  return (
    <div className="flex ">
      ...
      <div className="h-screen flex-1 p-1 md:p-7  overflow-y-scroll">
        <Navbar page="Ordonnances du jour" />
