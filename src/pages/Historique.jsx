  ...
  const fetchOrdo = async () => {
    try {
      ...
      const res = await axios.get(
        `${process.env.REACT_APP_API_URL}/ordonnance?page=${currentPage}&search=${filters.search}&date=${filters.date}&numero=${filters.numero}&status=${filters.status}&exceptEnrtardAndTerminer=true`,
        {
          headers: {
  ...
  return (
    <div className="flex ">
      ...
      <div className="h-screen flex-1 p-1 md:p-7   overflow-y-scroll">
        <Navbar page="Historique des ordonnances" />
                      ...
                      {ordonnance.collaborator ? (
                        ...
                        <>
                          ...
                          <button
                            ...
                            } // Disable button if the ordonnance is not selected
                          >
                            Confirm
                          </button>
                        </>
